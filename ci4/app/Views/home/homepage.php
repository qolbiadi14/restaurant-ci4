										...
										<?php if ($m['idkategori'] === $k['idkategori']) : ?>
											<div class="col-lg-4 col-md-6 special-grid drinks">
												<div class="gallery-single fix">
													...
													<div class="why-text">
														<a title="Tambah ke keranjang" href="<?= base_url('cart/buy/' . $m['idmenu']) ?>">Beli <i class="fa fa-shopping-cart" aria-hidden="true"></i></a>
														<a title="Lihat Produk" href="<?= base_url('productdetail/index/' . $m['idmenu']) ?>">Lihat Produk <i class="fa fa-eye" aria-hidden="true"></i></a>
														<h4><?= $m['menu'] ?></h4>
														<h5>Rp. <?= $m['harga'] ?></h5>
													</div>
												</div>
